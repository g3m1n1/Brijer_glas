...
lb.addEventListener('click',function(){
  var page = document.getElementById("pageThree");// input field's parent for a more accurate element search
  var usernameField = page.querySelector("[name=username]");
  var passwordField = page.querySelector("[name=password]");
